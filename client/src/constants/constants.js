...
export const DE_TAI_NAME_CHANGE_NOT_APPROVED = 'CXN';
export const DE_TAI_NAME_CHANGE_APPROVED = 'DXN';
export const DE_TAI_NAME_CHANGE_REJECTED = 'DTC';

export const DE_TAI_MID_PROGRESS_WAITING = 'CGV';
export const DE_TAI_MID_PROGRESS_NOT_APPROVED = 'CXN';
export const DE_TAI_MID_PROGRESS_APPROVED = 'DXN';
export const DE_TAI_MID_PROGESS_REJECTED = 'DTC';
