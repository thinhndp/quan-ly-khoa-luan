...
import { getDeTais, getDeTaisWithQuery, getDeTaiById, updateDeTaiById, createManyDeTais, deleteDeTaiById, applyForDeTai,
    ...
    getDeTaisWithPendingApproval, updateNameChange, getCurrrentKTHDeTais, cancelDeTaiApplication, approveMidTerm, undoApproveMidTerm,
    getPastDeTaisByGiangVien } from '../controllers/deTaiCtrl.js';
...
router.post('/get-active-by-giang-vien/:id', getCurrrentKTHDeTaisByGiangVien);
router.post('/get-past-by-giang-vien/:id', getPastDeTaisByGiangVien);
